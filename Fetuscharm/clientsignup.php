...
<head>
    <script>
        function formvalidation() {
            ...
            var ufile = document.clientform.profileimage.value;
            if (ufile == 0) {
                document.getElementById("a12").innerHTML = "Upload your document here ";
                check = false;
            }
            var coun = document.getElementById("countryselect").value;
            if (coun == "Select Country") {
                document.getElementById("a13").innerHTML = "Select your country";
                check = false;
            }
            var state = document.getElementById("stateselect").value;
            if (state == "Select State") {
                document.getElementById("a14").innerHTML = "Select your state";
                check = false;
            }
            var city = document.getElementById("cityselect").value;
            if (city == "Select City") {
                document.getElementById("a15").innerHTML = "Select your city";
                check = false;
            }
            return check;
        }
...
<body>
    ...
    if (isset($_POST['submit']) == "submit") {
        ...
        $email = $_POST['mail'];
        $qry = "select * from customerregistrationtb where emailID='$email'";
        $res = mysqli_query($con, $qry);
        $count = mysqli_num_rows($res);
        if ($count > 0) {
    
            header("location:clientsignup.php?err=1");
        } else {
            $fn = $_POST['fname'];
            $ln = $_POST['lname'];
            $e = $_POST['mail'];
            ...
            $sql = $link->insert("customerregistrationtb", array("firstName" => $fn, "lastName" => $ln, "emailID" => $e, "password" => $ps, "contactno" => $conno, "gender" => $g, "DOB" => $db, "addressLine1" => $addrl1, "addressLine2" => $addrl2, "pincode" => $pc, "countryID" => $country, "stateID" => $state, "cityID" => $city));
            if ($sql) {
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <div class="page-header text-center">
                        ...
                        <h1>Create a FREE account &amp; Book your packages.</h1>
                        <p>Start booking for your precious event!!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 singup-couple">
                    <div class="well-box">
                        <h2>Let's turn your dream into a reality!</h2>
                        <form method="post" name="clientform" onSubmit="return formvalidation();" enctype="multipart/form-data">
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="control-label">First Name</label>
                                <input type="text" id="fname" name="fname" placeholder="Your First Name" class="form-control input-md">
                                <span id="a1" style="color:red;">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Last Name</label>
                                <input type="text" id="lname" name="lname" placeholder="Your Last Name" class="form-control input-md">
                                <span id="a2" style="color:red;">
                            </div>
                            <div class="form-group">
                                <label class="control-label">E-mail</label>
                                <input type="email" id="mail" name="mail" placeholder="E-Mail" class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="cno" name="cno" placeholder="Contact no" class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-label">
                                    <input type="date" id="dob" name="dob" class="form-control input-md">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-label">
                                    <textarea name="adl1" id="adl1" placeholder="House no.,Street/Society" class="form-control input-md"></textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-label">
                                    <textarea name="adl2" id="adl2" placeholder="Area name" class="form-control input-md"></textarea>
                                </div>
                                <span id="a10" style="color:red;">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Pincode</label>
                                <input type="text" id="pin" name="pin" placeholder="Pincode" class="form-control input-md">
                            ...
                            <div id="citydropdown">
                                <div class="form-group">
                                    ...
                                    <span id="a15" style="color:red;">
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="submit" id="submit" name="submit" class="btn btn-primary">Create An Account</button>
                            </div>
                            <p><center>Already a Member? <a href="clientlogin.php">Log In</a></center></p>
                        </form>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="col-md-6 feature-block">
                            <div class="well-box">
                                ...
                                <div class="feature-content">
                                    <h3>Fetus Charm Checklist</h3>
                                   <p>All the things are added properly under supervision</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 feature-block">
                            <div class="well-box">
                                ...
                                <div class="feature-content">
                                    <h3>Package Budget</h3>
                                    <p>All the packages are at its minimal price</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 feature-block">
                            <div class="well-box">
                                ...
                                <div class="feature-content">
                                    <h3>Fetus Charm Vendors</h3>
                                    <p>Vendors with approval</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 feature-block">
