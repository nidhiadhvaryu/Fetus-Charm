...
if (isset($_POST['submit'])) {
	$email = $_POST['un'];
	$password = $_POST['pw'];
	$qry = "select * from vendorregistrationtb where emailID='$email' and password='$password' and isActive=1";
	$res = mysqli_query($con, $qry);
	$count = mysqli_num_rows($res);
	if ($count > 0) {
		while ($row = mysqli_fetch_array($res)) {
			session_start();
			$_SESSION['vid'] = $row['vendorID'];
			$_SESSION['un'] = $email;
...
<head>
	<script>
		function formvalidation() {
			...
			var u = document.vendorform.un.value;
			var p = document.vendorform.pw.value;
				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="p-40">
								<form method="post" name="vendorform" onSubmit="return formvalidation();">
									...
									<div class="row">
										...
										<div class="col-6">
											<div class="fog-pwd text-end">
												<a href="vendorforgotpassword.php" class="hover-warning"><i class="ion ion-locked"></i> Forgot password?</a><br>
											</div>
										</div>
										<div>
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Don't have an account? <a href="vendorregistration.php" class="text-warning ms-5">Sign Up</a></p>
								</div>
							</div>
						</div>
						<div class="text-center">
