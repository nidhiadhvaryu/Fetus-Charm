                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $order=$link->rawQuery("select * from orderproducttb op,orderitemtb oi,packagetb p,vendorregistrationtb v where v.vendorID=p.vendorID and p.packageID=oi.packageID and op.orderproductID=oi.orderproductID and op.isActive=1 and v.vendorID=? and op.orderproductID=?",array($vid,$oid));
                                                    foreach ($order as $or) {
