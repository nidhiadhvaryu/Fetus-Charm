            ...
            <div class="col-md-offset-3 col-md-6 well-box">
                <form action="reset-password-code.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" name="newpass" placeholder="Enter your new password" class="form-control input-md">
                    </div>
                    <div class="form-group">
                        <button id="submit" name="submit" class="btn btn-primary"><center>Reset Password</center></button>
                    </div>
                </form>
            </div>
        </div>
