            ...
            <div class="col-md-offset-3 col-md-6 well-box">
                <form action="reset_password.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="newpass" placeholder="Enter your new password" class="form-control input-md">
                    </div>
                    <div class="form-group">
					<center><button id="submit" name="submit" class="btn btn-primary">Reset Password</button></center>
                    </div>
                </form>
            </div>
        </div>
