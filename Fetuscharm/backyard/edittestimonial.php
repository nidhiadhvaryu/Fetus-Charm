...
if (isset($_POST['submit']) == "submit") {
	...
	$sql = $link->update("testimonialtb", array("testimonialName" => $tname,"testimonialDate" => $tdate,  "testimonialDescription" => $tdes));
	if ($sql) {
		...
		if ($img != null || $img != "") {
			...
			if (move_uploaded_file($_FILES['testimage']['tmp_name'], "files/testimonial/" . $pimage)) {
				$link->where('testimonialID', $blog_id);
									...
									<form novalidate method="post" name="blogform" onSubmit="return formvalidation();" enctype="multipart/form-data">
										<div class="row">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="testname" name="testname" class="form-control"  value="<?php echo $data['testimonialName']; ?>">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor" name="testdescription" class="form-control" ><?php echo $data['testimonialDescription']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
													...
													<div class="controls">
														...
														<img src="<?php echo $data['testimonialImage']; ?>" style="height:50px;width:50px">
													</div>
												</div>
                                                <div class="form-group">
                                                    <h5>Testimonial Date <span class="text-danger"></span></h5>
                                                    <div class="controls">
                                                        <input type="date" id="testdate" name="testdate" class="form-control" value="<?php echo $data['testimonialDate']; ?>">
                                                    </div>
