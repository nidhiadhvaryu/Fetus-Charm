...
if (isset($_POST['submit']) == "submit") {
    ...
    $sql = $link->insert("blogtb", array("blogName" => $bname, "blogTitle" => $btitle, "blogDate" => $bdate, "blogAuthor" => $bauthor, "blogShortdescription" => $bsdes, "blogDescription" => $bdes));
    if ($sql) {
...
<head>
    <script>
        function formvalidation() {
            ...
            var i = document.blogform.blogimage.value;
            if (i == 0) {
                document.getElementById("a3").innerHTML = "Upload your blog here ";
                check = false;
            }
            var d = document.blogform.blogdate.value;
            if (d == 0) {
                document.getElementById("a4").innerHTML = "Select Blog date ";
                check = false;
            }
            var au = document.blogform.blogauthor.value;
            if (au == 0) {
                document.getElementById("a5").innerHTML = "Enter Blog Author ";
                check = false;
            }
            var des = document.blogform.blogshortdescription.value;
            if (des == 0) {
                document.getElementById("a6").innerHTML = "Enter Blog Short Description ";
                check = false;
            }
    ...
    <title>Fetus Charm Admin - Blog</title>
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col">
                                    <form  method="post" name="blogform" onSubmit="return formvalidation();" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="date" id="blogdate" name="blogdate" class="form-control">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="blogshortdescription" name="blogshortdescription" class="form-control">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor" name="blogdescription" class="form-control"></textarea>
                                                    </div>
                                                </div>
