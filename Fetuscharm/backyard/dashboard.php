...
$qry="select count(vendorID) as vcount from vendorregistrationtb";
$res=mysqli_query($con,$qry);
while($row=mysqli_fetch_array($res)){
	$vecount=$row['vcount'];
}
$qry="select count(customerID) as ccount from customerregistrationtb";
$res=mysqli_query($con,$qry);
while($row=mysqli_fetch_array($res)){
	$cecount=$row['ccount'];
}
$qry="select count(categoryID) as catcount from categorytb";
$res=mysqli_query($con,$qry);
while($row=mysqli_fetch_array($res)){
	$catcount=$row['catcount'];
}
$qry="select count(orderproductID) as ordercount from orderproducttb";
$res=mysqli_query($con,$qry);
while($row=mysqli_fetch_array($res)){
	$orcount=$row['ordercount'];
}
...
<head>
	...
	<title>Fetus Charm Admin - Dashboard</title>
						...
						<div class="col-xl-6 col-12">
							<div class="box">
								<div class="box-header no-border pb-0">
									<h4 class="box-title">Fetus Charm Dashboard</h4>
								</div>
								<div class="box-body">
									<div class="row">
										<div class="col-md-6 col-12">
											<div class="info-box bg-transparent no-shadow px-0 min-h-80">
												...
												<div class="info-box-content pb-0">
													<p class="mb-0 fs-16">Total Vendor</p>
													<h2 class="my-0 fw-500 text-danger"><?php echo $vecount ?></h2>
												</div>
											</div>
										</div>
										<div class="col-md-6 col-12">
											<div class="info-box bg-transparent no-shadow px-0 min-h-80">
												...
												<div class="info-box-content pb-0">
													...
													<h2 class="my-0 fw-500 text-success"><?php echo $cecount ?></h2>
												</div>
											</div>
										</div>
										<div class="col-md-6 col-12">
											<div class="info-box bg-transparent no-shadow px-0 min-h-80">
												...
												<div class="info-box-content pb-0">
													<p class="mb-0 fs-16">Total Categories</p>
													<h2 class="my-0 fw-500 text-info"><?php echo $catcount ?></h2>
												</div>
											</div>
										</div>
										<div class="col-md-6 col-12">
											<div class="info-box bg-transparent no-shadow px-0 min-h-80">
												...
												<div class="info-box-content pb-0">
													...
													<h2 class="my-0 fw-500 text-info"><?php echo $orcount ?></h2>
												</div>
											</div>
										</div>
									</div>
